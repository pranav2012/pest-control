...
const PromotionalBanner = () => {
  return (
    <motion.div 
      ...
      className="w-full bg-[#e7f5e8] border-b border-[#25D366]/20 fixed top-0 z-50 h-[42px]"
    >
          ...
          <div className="flex items-center space-x-3">
            <div className="shrink-0">
              <div className="relative">
                ...
                <div className="w-8 h-8 bg-[#25D366]/30 rounded-lg flex items-center justify-center relative">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-[#075e54] text-sm font-medium flex items-center space-x-2">
                  <motion.span
                    ...
                    className="bg-[#25D366] text-white rounded-full px-2 py-0.5 text-xs font-bold tracking-wide shadow-sm whitespace-nowrap inline-block"
                  >
                    20% OFF
                  </motion.span>
