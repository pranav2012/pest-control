...
const Hero = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const whatsappButton = heroData.main_content.cta_buttons.find(btn => btn.type === 'whatsapp')
      const whatsappUrl = whatsappButton?.link || 'https://api.whatsapp.com/send?phone=918882002546&'
          ...
          >
            <div className="bg-white rounded-2xl shadow-2xl p-5">
              ...
              <form onSubmit={handleSubmit} className="space-y-2.5">
                ...
                >
                  {isSubmitting ? 'Sending...' : heroData.contact_form.submit_button.text}
                </motion.button>
